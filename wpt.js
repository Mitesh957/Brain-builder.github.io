...
var questionBank= [
    {
        ...
        option : ['London','Paris','Berlin','Madrid'],
        answer : 'Paris'
    },
    {
        question : 'Which of the following is the highest mountain in the world?',
        option : ['Mount Kilimanjaro','Mount Aconcagua','Mount Everest','Mount Denali'],
    ...
    },
    {
        ...
        option : ['Spain','Germany','Switzerland','Italy'],
        answer : 'Switzerland'
    },
    {
        question : 'Which of the following continents is the largest in terms of land area?',
        option : ['Africa','South America','Asia','Europe'],
        answer : 'Asia'
    }
]
